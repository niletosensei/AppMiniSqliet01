...
public class MainActivity extends AppCompatActivity {
    ...
    private void showmemoryall() {
        ...
        for(int i = 0; i < cursor.getCount(); i++){
            ...
            titleStrings[i] = cursor.getString(cursor.getColumnIndex(MemOpenHelper.COLUMN_TITLE));
            detailStrings[i] = cursor.getString(cursor.getColumnIndex(MemOpenHelper.COLUMN_DETAIL));
            dateStrings[i] = cursor.getString(cursor.getColumnIndex(MemOpenHelper.COLUMN_DATE));
            cursor.moveToNext();
        }
        cursor.close();
        Showmem showmem = new Showmem(MainActivity.this,titleStrings,detailStrings,dateStrings);
        listmemory.setAdapter(showmem);
        listmemory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                alb.setPositiveButton("Edit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) { Intent gotoedit = new Intent(MainActivity.this,EditmemoryActivity.class);
